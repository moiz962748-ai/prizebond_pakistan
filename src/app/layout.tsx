...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#002B15] text-slate-800 flex flex-col md:flex-row">
      ...
      <aside className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-[#003B1D] border-r border-emerald-950/35 transition-all duration-300 hidden md:flex flex-col justify-between p-5 text-white shadow-xl`}>
      ...
      {mobileDrawerOpen && (
        <div className="fixed inset-0 z-50 bg-black/60 md:hidden flex">
          <div className="w-72 bg-[#003B1D] h-full p-5 text-white flex flex-col justify-between shadow-2xl">
            <div className="space-y-6">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-y-auto bg-[#002B15]">
        <header className="bg-[#003B1D] border-b border-emerald-950/35 px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-white shadow-md">
